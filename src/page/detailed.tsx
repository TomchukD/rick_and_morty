...
import { СharacterFull } from 'src/interface/interface';

function Detailed() {
    const character: СharacterFull = {
        name: 'asd',
        episodList: [],
        gender: 'Female',
        id: 444,
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <List>
                    {character.episodList.map((episode, index) => (
                        <ListItem key={index}>
